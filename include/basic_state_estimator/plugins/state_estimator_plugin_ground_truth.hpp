#ifndef __STATE_ESTIMATOR_PLUGIN_GROUND_TRUTH_HPP__
#define __STATE_ESTIMATOR_PLUGIN_GROUND_TRUTH_HPP__

#include "basic_state_estimator/plugins/state_estimator_plugin_base.hpp"
namespace state_estimation_plugin_ground_truth {
